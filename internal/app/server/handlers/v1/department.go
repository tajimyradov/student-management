...
func (h *V1) addDepartment(c *gin.Context) {
...
func (h *V1) updateDepartment(c *gin.Context) {
	var department models.Department
	if err := c.ShouldBindJSON(&department); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
...
func (h *V1) deleteDepartment(c *gin.Context) {
	id, err := strconv.Atoi(c.Param("did"))
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
...
func (h *V1) getDepartmentByID(c *gin.Context) {
	id, err := strconv.Atoi(c.Param("did"))
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
