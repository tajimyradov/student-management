...
func (h *V1) addProfession(c *gin.Context) {
...
func (h *V1) updateProfession(c *gin.Context) {
	var input models.Profession
	if err := c.ShouldBindJSON(&input); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
...
func (h *V1) deleteProfession(c *gin.Context) {
	id, err := strconv.Atoi(c.Param("pid"))
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
...
func (h *V1) getProfessionByID(c *gin.Context) {
	id, err := strconv.Atoi(c.Param("pid"))
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
...
func (h *V1) getProfessions(c *gin.Context) {
